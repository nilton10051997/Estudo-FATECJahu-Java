...
public class Programa8extra1 {
    public static void main(String[] args) {
        Scanner teclado = new Scanner(System.in);
        // Declarando as variáveis:
        String nome="?",sexo="?",estudante="?",senhoria="?",resposta="";
        double idade=0,ingresso=100,desconto=0,totalVendas=0;
        do {
            ingresso=100;
            // Entrada de dados:
            ...
            totalVendas = totalVendas+ingresso;
            // Saída de dados:
            ...
            System.out.println("Deseja continuar vendendo?");
